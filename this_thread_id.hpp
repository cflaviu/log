...
#ifndef BOOST_LOG_ATTRIBUTES_THIS_THREAD_ID_HPP_INCLUDED_
#define BOOST_LOG_ATTRIBUTES_THIS_THREAD_ID_HPP_INCLUDED_
...
protected:
        ...
        public attribute_value::impl
    {
        ...
        {
            static std::atomic<value_type> thread_no = 0;
            thread_local auto id = thread_no++;
            return id;
        }
    ...
    public:
        ...
        intrusive_ptr< attribute_value::impl > detach_from_thread()
        {
            ...
            return new detached_value(get_id());
        }
...
public:
     ...
     * Default constructor
     */
    this_thread_id() : attribute(new impl())
    {
    }
    /*!
     * Constructor for casting support
     */
    explicit this_thread_id(cast_source const& source) :
...
#endif // BOOST_LOG_ATTRIBUTES_THIS_THREAD_ID_HPP_INCLUDED_
